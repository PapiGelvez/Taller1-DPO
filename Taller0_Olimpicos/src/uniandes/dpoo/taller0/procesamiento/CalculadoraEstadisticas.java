...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Calcula el pais al que representa un atleta
	 * 
	 * @return El nombre del pais
	 */
	public String paisDelAtleta(String nombre_atleta)
	{
		Atleta elAtleta = buscarAtleta(nombre_atleta);
		Pais clase_pais = null;
		String resultado = null;
		if (elAtleta == null)
		{
			return resultado;
		}
		clase_pais = elAtleta.darPais();
		resultado = clase_pais.darNombre();
