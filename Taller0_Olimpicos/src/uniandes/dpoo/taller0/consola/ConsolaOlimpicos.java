...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país que representa un atleta dado");
		System.out.println("14. Salir de la aplicación\n");
	}

	/**
	 * Le muestra al usuario el pais al cual representa un atleta dado
	 */
	private void ejecutarBuscarPaisDeAtleta()
	{
		...
		String pais = calculadora.paisDelAtleta(nombre_atleta);
		if (pais == null)
		{
			System.out.println("No se encontró un pais al que represente el atleta llamado " + nombre_atleta);
		}
		else
		{
